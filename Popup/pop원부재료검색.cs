...
{
    public partial class pop원부재료검색 : Form
    {
        private int iCnt;
        ...
        private void pop원부재료검색_Load(object sender, EventArgs e)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendLine("where RAW_MAT_NM like '%" + txtSrch.Text.ToString() + "%' ");
            sb.AppendLine(" OR LABEL_NM like '%" + txtSrch.Text.ToString() + "%' ");
            sb.AppendLine(" OR RAW_MAT_CD like '%" + txtSrch.Text.ToString() + "%' ");
        ...
        private void GridRecord_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            sRetNm = "" + (string)GridRecord.Rows[iCnt].Cells["LABEL_NM"].Value;
