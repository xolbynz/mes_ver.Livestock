...
{
    public partial class frm미송등록 : Form
    {
        ...
        private string sSettingFile = "return_store.xml";
        ...
        private void frm미송등록_Load(object sender, EventArgs e)
        {
        ...
        private void bindData(string condition)
        {
            ...
            try
            {
                wnDm wDm = new wnDm();
                DataTable dt = null;
                dt = wDm.fn_PRODUCT_STORE_List(condition);
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        this.GridRecord.Rows[i].Cells[7].Value = decimal.Parse(dt.Rows[i]["STOCK_AMOUNT"].ToString().Trim()).ToString("#,0");
                        this.GridRecord.Rows[i].Cells[8].Value = decimal.Parse(dt.Rows[i]["STOCK_VAT"].ToString().Trim()).ToString("#,0");
                    }
                }
            }
            catch (Exception ex)
        ...
        private void getDetailPost(string sKey, string sKey2)
        {
            ...
            try
            {
                wnDm wDm = new wnDm();
                DataTable dt = null;
                dt = wDm.fn_PRODUCT_STORE_Detail(sKey, sKey2);
        ...
        private bool validate_InputBox2()
        {
            bool bRet = true;
            ...
            try
            {
                ...
                // 05=폐업거래처, 06=부도거래처
                if (txt거래분류.Text == "05" || txt거래분류.Text == "06")
                {
                    MessageBox.Show("[ 폐업거래처 ]는 등록할수 없습니다.");
                    return false;
                }
        ...
        private bool updatePost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" update PRODUCT_STORE set ");
                ...
                for (int kk = 0; kk < grdItem.Rows.Count; kk++)
                {
                    ...
                    if (s코드 != "")
                    {
                        ...
                        sb.AppendLine(" select @cnt = count(*) from PRODUCT_STORE ");
                        sb.AppendLine(" where STOCK_DATE = @STOCK_DATE ");
                        sb.AppendLine("     and STOCK_NUM = @p1 ");
                        ...
                        sb.AppendLine(" insert into PRODUCT_STORE ( ");
                ...
                sb.AppendLine(" delete from PRODUCT_STORE ");
                sb.AppendLine(" where STOCK_DATE = @STOCK_DATE ");
                sb.AppendLine("     and STOCK_NUM = @p1 ");
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Update-PRODUCT_STORE");
        ...
        private bool deletePost()
        {
            ...
            try
            {
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Delete-PRODUCT_STORE");
                if (qResult > 0) bRet = true;
                else bRet = false;
        ...
        private bool movePost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" declare @new_NUM as nvarchar(4) ");
                sb.AppendLine(" declare @new_Day as nvarchar(10) ");

                sb.AppendLine(" set @new_Day = convert(nvarchar(10), getdate(), 120) ");

                sb.AppendLine(" select @new_NUM = right('000' + convert(nvarchar(4), isnull(max(convert(int, STOCK_NUM)), 0) + 1), 4) ");
                sb.AppendLine(" from NUM_STOCK ");
                sb.AppendLine(" where STOCK_DATE = @new_Day ");

                sb.AppendLine(" if (@new_NUM = '0001') ");
                sb.AppendLine(" begin ");
                sb.AppendLine("     insert into NUM_STOCK (STOCK_DATE, STOCK_NUM) values (@new_Day, @new_NUM) ");
                sb.AppendLine(" end ");
                sb.AppendLine(" else ");
                sb.AppendLine(" begin ");
                sb.AppendLine("     update NUM_STOCK set STOCK_NUM = @new_NUM where STOCK_DATE = @new_Day ");
                sb.AppendLine(" end ");

                sb.AppendLine(" insert into PRODUCT_STOCK ( ");
                sb.AppendLine("     STOCK_DATE ");
                sb.AppendLine("     , STOCK_NUM ");
                sb.AppendLine("     , STOCK_CODE ");
                sb.AppendLine("     , STOCK_KIND ");
                ...
                sb.AppendLine("     , MEMO3 ");
                sb.AppendLine("     , MEMO4 ");
                sb.AppendLine("     , CHK_STOCK ");
                sb.AppendLine("     , CHK_STOCK1 ");
                sb.AppendLine("     , CHK_PRT ");
                sb.AppendLine("     , STOCK_ILNUM ");
                sb.AppendLine("     , TAX_DATE ");
                sb.AppendLine("     , TAX_NUM ");
                sb.AppendLine("     , USER_CODE ");
                sb.AppendLine("     , PRODUCT_KIND ");
                sb.AppendLine("     , PRODUCT_KIND1 ");
                sb.AppendLine("     , PRODUCT_SPEC1 ");
                ...
                sb.AppendLine("     , DEPT_CODE1 ");
                sb.AppendLine("     , DEPT_CODE2 ");
                sb.AppendLine("     , MAGAM_CHK ");
                sb.AppendLine("     , 할인율 ");
                sb.AppendLine("     , 표준단가 ");
                sb.AppendLine("     , 퍼센트마감 ");
                sb.AppendLine("     , 입력일자 ");
                sb.AppendLine(" ) select ");
                sb.AppendLine("     @new_Day ");
                sb.AppendLine("     , @new_NUM ");
                sb.AppendLine("     , STOCK_CODE ");
                sb.AppendLine("     , STOCK_KIND ");
                sb.AppendLine("     , CUST_CODE1 ");
                sb.AppendLine("     , MAN_CODE1 ");
                ...
                sb.AppendLine(" from PRODUCT_STORE ");
                sb.AppendLine(" where STOCK_DATE = @STOCK_DATE ");
                sb.AppendLine("     and STOCK_NUM = @p1 ");
                sb.AppendLine("     and STOCK_ILNUM <> -1 "); //-1 삭제대상 건 제외하고 복사

                // 수불등록(STORE_STOCK)
                sb.AppendLine(" insert into STORE_STOCK ( ");
                sb.AppendLine("     STOCK_DATE ");
                sb.AppendLine("     , STOCK_NUM ");
                sb.AppendLine("     , STOCK_CODE ");
                sb.AppendLine("     , STOCK_KIND ");
                ...
                sb.AppendLine("     , JEJO_DATE ");
                sb.AppendLine("     , STOCK_BIGO ");
                sb.AppendLine("     , PRODUCT_NAME ");
                sb.AppendLine("     , PRODUCT_SPEC ");
                sb.AppendLine("     , PRODUCT_UNIT ");
                sb.AppendLine("     , MIP_DEVP_NO ");
                sb.AppendLine("     , 입력일자 ");
                sb.AppendLine("     , LOT_NO ");
                sb.AppendLine(" ) select ");
                sb.AppendLine("     @new_Day ");
                sb.AppendLine("     , @new_NUM ");
                sb.AppendLine("     , a.STOCK_CODE ");
                sb.AppendLine("     , a.STOCK_KIND ");
                sb.AppendLine("     , a.STOCK_QTY ");
                sb.AppendLine("     , a.STOCK_PRICE ");
                sb.AppendLine("     , a.STOCK_AMOUNT ");
                sb.AppendLine("     , a.CUST_CODE1 ");
                sb.AppendLine("     , null ");
                sb.AppendLine("     , null ");
                sb.AppendLine("     , '' ");
                sb.AppendLine("     , a.PRODUCT_NAME ");
                sb.AppendLine("     , a.PRODUCT_SPEC1 ");
                sb.AppendLine("     , c.CODE_DESC ");
                sb.AppendLine("     , null ");
                sb.AppendLine("     , getdate() ");
                sb.AppendLine("     , null ");
                sb.AppendLine(" from PRODUCT_STORE a ");
                sb.AppendLine("     inner join PRODUCT b on b.PRODUCT_CODE = a.STOCK_CODE ");
                sb.AppendLine("     left outer join UnitCode c on c.UNIT_CODE = b.UNIT_CODE ");
                sb.AppendLine(" where a.STOCK_DATE = @STOCK_DATE ");
                sb.AppendLine("     and a.STOCK_NUM = @p1 ");


                sb.AppendLine(" delete from PRODUCT_STORE ");
                sb.AppendLine(" where STOCK_DATE = @STOCK_DATE ");
                sb.AppendLine("     and STOCK_NUM = @p1 ");
                //sb.AppendLine("     and STOCK_ILNUM = -1 "); //전부삭제
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Moveto-PRODUCT_STOCK");
                if (qResult > 0) bRet = true;
                else bRet = false;
