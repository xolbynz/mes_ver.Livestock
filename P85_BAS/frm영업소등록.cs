...
{
    public partial class frm영업소등록 : Form
    {
        ...
        private void frm영업소등록_Load(object sender, EventArgs e)
        {
        ...
        private void init_ComboBox()
        {
            ...
            wConst.ComboBox_Read_Blank(cmb지역, sqlQuery);
        ...
        private void bindData(string condition)
        {
            ...
            try
            {
                wnDm wDm = new wnDm();
                DataTable dt = null;
                dt = wDm.fn_DEPTCODE_List(condition);
        ...
        private bool validate_InputBox()
        {
            ...
            try
            {
                ...
                if ("" + cmb지역.SelectedValue.ToString() == "")
                {
                    MessageBox.Show("[ 지역구분 ]을 입력하세요.");
                    return false;
                }
        ...
        private bool deletePost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" delete from DEPTCODE ");
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Delete_DEPTCODE_Table");
                if (qResult > 0) bRet = true;
                else bRet = false;
