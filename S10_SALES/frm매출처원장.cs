...
namespace 스마트팩토리.S10_SALES
{
    public partial class frm매출처원장 : Form
    {
        ...
        private void in_grid_logic()
        {
            ...
            dt = wDm.fn_Sales_Ledger_List(sb.ToString()
                , "and Z.SOO_DATE >= '" + start_date.Text.ToString() + "' and Z.SOO_DATE <= '" + end_date.Text.ToString() + "' and Z.CUST_CD = '" + txt_srch2.Text.ToString() + "'   "
