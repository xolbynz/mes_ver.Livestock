...
{
    public partial class frm영업소수금 : Form
    {
        ...
        private string sSettingFile = "collect_branch.xml";
        ...
        private void frm영업소수금_Load(object sender, EventArgs e)
        {
        ...
        private void init_ComboBox()
        {
            ...
            wConst.set_Combo수금구분_영업소(false, cmb구분);
        ...
        private void getDetailPost(string sKey, string sKey2)
        {
            ...
            try
            {
                wnDm wDm = new wnDm();
                DataTable dt = null;
                dt = wDm.fn_PRODUCT_COLLECT_DEPT_Detail(sKey, sKey2);
        ...
        private bool insertPost()
        {
            ...
            try
            {
                ...
                if (sUser_Man != "999" && sUser_Dept.Substring(0, 1) != "0")
                {
                    ...
                    sb.AppendLine(" where COLLECT_DATE = '" + dtp일자.Text + "' ");
                ...
                else
                {
                    ...
                    sb.AppendLine(" from PRODUCT_COLLECT_DEPT ");
                    sb.AppendLine(" where COLLECT_DATE = '" + dtp일자.Text + "' ");
                    sb.AppendLine("     and substring(COLLECT_NUM, 1, 1) = '0' ");
                ...
                sb.AppendLine(" insert into PRODUCT_COLLECT_DEPT ( ");
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Insert-PRODUCT_COLLECT_DEPT");
        ...
        private bool updatePost()
        {
            ...
            try
            {
                ...
                int qResult = wAdo.SqlCommandEtc(sCommand, "Update-PRODUCT_COLLECT_DEPT");
                if (qResult > 0) bRet = true;
                else bRet = false;
